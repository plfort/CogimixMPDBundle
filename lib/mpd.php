<?php
namespace Cogipix\CogimixMPDBundle\lib;
/*
 *
 * Sven Ginka 03/2010
...
define("MPD_CMD_LSPLINFO",    "listplaylistinfo");
...
class mpd {
    ...
    function GetDir($dir = "",$sort = "") {
        ...
        //usort($array_file,array("mpd", "msort"));
        // 3rd: rebuild
        $array_return= array(
...
function getPlaylistInfo($name){
    $return = null;
    $resp = $this->SendCommand(MPD_CMD_LSPLINFO,$name);
    if($resp != null){
        $return= $this->_parseFileListResponse($resp);
    }
        return $return;
    ...
    var $COMPATIBILITY_MAX_TBL = array(
     ...
     public static function msort($a,$b) {
   ...
   public static function picksort($pick) {
        global $sort_array;
